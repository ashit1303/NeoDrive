...
mailer
subdomains
logger / elastic search / kibana
load balancer  script setup
script to start and run everything
caching
prevent table creation if entry not found in table
puppeteer 
...
liftbridge without any npm module (to pass file destination for further task)
redis for caching last fetched files 
nodejs - 2 clusters  and 2 instance 
mysql -to store uploaded file 

auth 
login id / email password => jwt
